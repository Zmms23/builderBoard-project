...
class TasksRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ->visible(fn (): bool => filled($this->getOwnerRecord()->project_id))
                    ->fillForm(fn (): array => $this->taskDefaults())
    ...
    {
        $company = $this->getOwnerRecord()->company;
    ...
    /**
     * @return array{project_id: int|string|null}
     */
